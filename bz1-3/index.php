		...
		<div id="ms">
			<div id="lf" style="float:left;">
				...
				<div class="dbor" style="margin:3px; width:95%; height:20%; line-height:100px;">
					<span class="t">進站總人數 :
					<?=$Total->find(1)['total'];?>1 </span>
				</div>
			</div>
			<!-- di start to front/main -->
			<?php
			$do=$_GET['do']??'main';
			$file="./front/{$do}.php";
			if(file_exists($file)){
			...
			<div class="di di ad" style="height:540px; width:23%; padding:0px; margin-left:22px; float:left; ">
				...
				<div style="width:89%; height:480px;" class="dbor">
					...
					?>
					<div id="ssaa<?=$idx;?>" class="im cent"><img src="./img/<?=$row['img'];?>" style="width:150px;height:103px;border:3px solid orange;margin:3px"></div>
					<?php
					}
					?>
					<script>
