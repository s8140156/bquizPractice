<style>
	...
	.active{
		...
		background-color: white; /*點選時該文章背景色白*/
	}
...
<!-- article>section#section0*4>h2+pre -->
<article>
	<section id="section01" style="display:block"> <!--預設先讓第一個文章先顯示-->
		<h2>健康新知</h2>
		<pre>
...
<script>
	$(".tag").on('click',function(){
		...
		$('section').hide() //這邊section應該是指element selection
		$('#'+id).show()
